...
public final class FollowUpReminderWorker_Factory {
  ...
  public FollowUpReminderWorker_Factory(Provider<GitHubRepository> repositoryProvider,
  ...
  public FollowUpReminderWorker get(Context context, WorkerParameters workerParams) {
    return newInstance(context, workerParams, repositoryProvider.get(), prefsProvider.get(), notifHelperProvider.get());
  }

  public static FollowUpReminderWorker_Factory create(Provider<GitHubRepository> repositoryProvider,
      Provider<PreferencesManager> prefsProvider,
      Provider<NotificationHelper> notifHelperProvider) {
    return new FollowUpReminderWorker_Factory(repositoryProvider, prefsProvider, notifHelperProvider);
  }

  public static FollowUpReminderWorker newInstance(Context context, WorkerParameters workerParams,
      GitHubRepository repository, PreferencesManager prefs, NotificationHelper notifHelper) {
    return new FollowUpReminderWorker(context, workerParams, repository, prefs, notifHelper);
  }
}
