...
public final class FloatingWidgetService extends android.app.Service {
    ...
    private final void startBreathingAnimation() {
    }
    ...
    private final void updatePanel(com.gitcommitbuddy.data.db.CommitCacheEntity cache, int limit) {
    }
